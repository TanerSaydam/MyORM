...
Bu proje, EF Core tarzýnda sýfýrdan bir ORM (Object-Relational Mapper) yazmayý gösteren bir eðitim amaçlý projedir. Bu ORM, Read iþlemini gerçekleþtirebilmenizi saðlar.

## Proje Özeti

Bu projede, bir veritabaný baðlamý (`DbContext`) ve varlýk setleri (`DbSet`) oluþturma ve yönetme iþlemlerini gösteriyoruz. Örnek bir `Product` sýnýfý kullanarak veritabanýndan veri çekme iþlemini gerçekleþtirdik.
...
#### MyContext ve MyContextBuilder Sýnýflarý
...
class MyContext
{
    ...
    private void InitializeDbSets()
    {
        ...
        foreach (var property in properties)
        {
            ...
            var tableName = entityType.Name + "s"; // Basit bir tablo adý belirleme mantýðý, özelleþtirilebilir
...
Projenin nasýl kullanýlacaðýný göstermek için aþaðýdaki örnek kodu inceleyebilirsiniz:
...
## Buraya kadar okuduysanýz Repoyu yýldýzlayarak destek verebilirsiniz :)
